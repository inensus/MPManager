<template>
    ...
    >
        <md-card>
                ...
                <div class="md-layout md-gutter">
                    ...
                    <div
                        ...
                        <form class="md-layout md-gutter" data-vv-scope="Elastic-Form">
                            <div
                                class="md-layout-item md-xlarge-size-30 md-large-size-30 md-medium-size-30 md-small-size-v">
            ...
            <md-card-actions>
                <md-button role="button" class="md-raised md-primary" :disabled="loading" @click="updateTariff">Save
                </md-button>
    ...
    methods: {
        ...
        addComponent (addedType) {
            if (addedType === 'component') {
                this.components = this.tariffService.addAdditionalCostComponent(addedType)
            } else {
                this.elasticUsageTimes = this.tariffService.addAdditionalCostComponent(addedType)
            }
        },
        removeComponent (addedType, id) {
            if (addedType === 'component') {
                ...
                this.elasticUsageTimes = this.tariffService.removeAdditionalComponent(addedType, id)
            }
