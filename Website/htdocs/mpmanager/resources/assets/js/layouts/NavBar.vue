<template>
  <header class="site-header header-s1 is-sticky" style="position:fixed; width: 100%; z-index: 10">
    <div class="navbar navbar-primary">
      <div class="container">
        <!-- Logo -->
        <a class="navbar-brand" routerLink="/">
          <img class="logo" alt="logo" src="https://www.inensus.com/images/logo.png" />
        </a>
