<header id="header">
    <div id="logo-group" style="background: #ffffff!important;">

        <!-- PLACE YOUR LOGO HERE -->
        <span id="logo"> <img src="{{asset('admin/img/logo.png')}}" alt="Your Company"> </span>
        ...
        <ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
            <li class="">
                <a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown">
                    <img src="{{asset('admin/img/avatars/sunny.png')}}" alt="kkk Doe" class="online"/>
                </a>
